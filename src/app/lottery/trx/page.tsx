...
export default function TrxPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-100 text-foreground pb-24 max-w-lg mx-auto relative">
            <header className="bg-green-500 text-white p-4 flex items-center justify-between sticky top-0 z-10">
                ...
                <div className="flex items-center space-x-1">
                    ...
                    <span className="font-bold text-lg">TRX WinGo</span>
                </div>
            ...
            <main className="space-y-4">
                <div className="bg-green-500 p-4 pt-2">
                    ...
                    <div className="flex items-center bg-green-400/80 text-white rounded-lg p-2 mt-3 text-xs">
                ...
                <div className="px-2">
                    <Tabs defaultValue="30sec" className="w-full" onValueChange={(value) => {
                        ...
                        <TabsList className="grid grid-cols-4 bg-transparent p-0 h-auto gap-1 sm:gap-2">
                            <TabsTrigger value="30sec" className="data-[state=active]:bg-white data-[state=active]:text-green-500 data-[state=active]:shadow-md rounded-t-lg bg-green-400 text-white border-b-2 border-green-500 data-[state=active]:border-transparent py-2 sm:py-3 text-xs sm:text-sm">
                                WinGo 30s
                            </TabsTrigger>
                            <TabsTrigger value="1min" className="data-[state=active]:bg-white data-[state=active]:text-green-500 data-[state=active]:shadow-md rounded-t-lg bg-gray-200 text-gray-500 py-2 sm:py-3 text-xs sm:text-sm">
                                WinGo 1m
                            </TabsTrigger>
                            <TabsTrigger value="3min" className="data-[state=active]:bg-white data-[state=active]:text-green-500 data-[state=active]:shadow-md rounded-t-lg bg-gray-200 text-gray-500 py-2 sm:py-3 text-xs sm:text-sm">
                                WinGo 3m
                            </TabsTrigger>
                            <TabsTrigger value="5min" className="data-[state=active]:bg-white data-[state=active]:text-green-500 data-[state=active]:shadow-md rounded-t-lg bg-gray-200 text-gray-500 py-2 sm:py-3 text-xs sm:text-sm">
                                WinGo 5m
                            </TabsTrigger>
                        </TabsList>
                        <TabsContent value="30sec" className="bg-white p-2 sm:p-4 rounded-b-lg shadow-md -mt-1">
                            <div className="bg-green-100/50 border border-green-200 rounded-lg p-2 sm:p-3">
                                <div className="flex justify-between items-center">
                                    <Button variant="outline" className="text-green-500 border-green-500 h-6 text-xs px-2"><HelpCircle className="w-3 h-3 mr-1"/>How to play</Button>
                                    <div className="text-right">
                                        <p className="text-xs sm:text-sm text-muted-foreground">Time remaining</p>
                                    </div>
                                </div>
                                <div className="flex justify-between items-center mt-2">
                                    <p className="font-bold text-base sm:text-lg">TRX WinGo 30sec</p>
                            ...
                            <div className="grid grid-cols-5 gap-1.5 sm:gap-2">
                             ...
                             <div className="grid grid-cols-7 gap-1 sm:gap-2 my-3 sm:my-4 items-center">
                                <Button variant="outline" className="text-green-500 border-green-300 text-xs px-1 h-8 sm:h-auto sm:px-2">Random</Button>
                        ...
                        <TabsContent value="results">
                             <Card>
                                <CardContent className="p-0">
                                    <div className="grid grid-cols-4 bg-green-500 text-white text-center text-sm py-2 rounded-t-lg">
                                        <div>Period</div>
                                        <div>Number</div>
                                        <div>Big Small</div>
                                        <div>Color</div>
            ...
            <footer className="fixed bottom-0 left-0 right-0 bg-white border-t p-2 flex justify-around items-center max-w-lg mx-auto shadow-[0_-2px_10px_rgba(0,0,0,0.05)]">
                <Button variant="ghost" className="flex flex-col h-auto items-center text-green-500">
