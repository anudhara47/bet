        ...
        <div className="min-h-screen bg-neutral-100 text-gray-800 pb-40 max-w-lg mx-auto">
            ...
            <main className="px-4">
                <Card className="rounded-xl overflow-hidden my-4 bg-transparent border-none">
                    <CardContent className="p-0">
                         ...
                         >
                            <CarouselContent>
                                <CarouselItem>
                                    <Image src="https://picsum.photos/600/400?random=1" alt="Promo Banner 1" width={600} height={400} className="w-full h-auto rounded-xl" data-ai-hint="wheat field"/>
                                </CarouselItem>
                                <CarouselItem>
             ...
             <footer className="fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-sm border-t p-2 flex justify-around items-start max-w-lg mx-auto">
                <div className="w-12 h-12 -mt-6 bg-white rounded-full flex items-center justify-center shadow-lg">
